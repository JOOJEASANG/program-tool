...
def test_modular_app_page_starts_shell_before_deferred_firebase_access_scripts() -> None:
    page = source("apps/index.html")
    shell_tag = '<script defer src="/js/studio-app-shell.js?v=20260911-1"></script>'
    ...
    assert 'studio-app-shell.js?v=20260901-7' not in page

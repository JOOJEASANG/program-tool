...
def test_all_product_live_dimensions_are_outside_canvas_at_toolbar_left():
    ...
    assert "/js/print-checker/spine-live-dimension.js?v=20260911-5" in index
    ...
    assert "scheduleSettledSync" in source
    assert "v5-stable-product-toolbar-left" in source

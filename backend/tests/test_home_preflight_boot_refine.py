...
def test_main_home_is_static_and_business_name_only():
 ...
 for label in ("디자인 검토","AI 디자인 제작","스마트 인쇄배치","PDF배치","PDF편집","PDF 도구 모음"): assert label in index
...
def test_hosting_stage_loads_split_pdf_home_entries_without_boot_guard_duplication():
 ...
 for marker in ("name:'AI 디자인 제작'","url:'ai-design-maker/'","name:'스마트 인쇄배치'","url:'smart-print-layout/'","name:'PDF배치'","url:'pdf-editor/'","name:'PDF편집'","url:'pdf-editor-advanced'","pdf-home-six-programs-v9","pdfHomeWorkspace='six-programs'"): assert marker in launcher

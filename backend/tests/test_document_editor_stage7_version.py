...
def test_document_editor_stage7_release_floor_and_runtime_sync():
    ...
    comments = (ROOT / "js" / "document-editor" / "comments.js").read_text(encoding="utf-8")
    ...
    assert "/css/document-editor-comments.css?v=20260824-1" in page
    assert "/js/document-editor/comments.js?v=20260824-1" in page
    assert "stage:'document-editor-comments-stage7'" in comments

...
def test_document_editor_stage6_release_floor_and_runtime_sync():
    ...
    outline = (ROOT / "js" / "document-editor" / "outline.js").read_text(encoding="utf-8")
    ...
    assert "/css/document-editor-outline.css?v=20260824-1" in page
    assert "/js/document-editor/outline.js?v=20260824-1" in page
    assert "stage:'document-editor-outline-stage6'" in outline

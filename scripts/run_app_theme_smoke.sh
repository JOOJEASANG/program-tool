...
if [[ -z "$BROWSER" ]]; then echo "Headless Chrome/Chromium executable not found for theme smoke." >&2; rm -rf "$PROFILE_DIR"; exit 1; fi
...
echo "Program Studio theme browser smoke passed using $BROWSER"

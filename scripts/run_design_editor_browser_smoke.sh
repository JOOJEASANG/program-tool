...
bash "$ROOT_DIR/scripts/run_design_editor_leaflet2_layout_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_fold_runtime_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_print_products_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_user_flow_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_pdf_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_print_production_stage2_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_text_auto_fit_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_typography_pro_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_local_fonts_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_shape_border_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_shape_inspector_ux_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_reset_all_menus_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_essential_workspace_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_canvas_viewport_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_full_preview_smoke.sh"
bash "$ROOT_DIR/scripts/run_design_editor_stability_audit_smoke.sh"

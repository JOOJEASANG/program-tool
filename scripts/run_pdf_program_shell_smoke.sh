...
run_case "pdf-editor-shell-smoke.html" "$OUT_DIR/pdf-editor-shell-smoke-dom.html" 'PASS: PDF sidebar remains stable with pinned upload and collapsible tool sections'
reset_profile
...
reset_profile
run_product_case "pdf-editor-workflow-v2-smoke.html" "$OUT_DIR/pdf-editor-workflow-v2-smoke-dom.html" 'data-workflow-v2-smoke="pass"' 'PASS: PDF editor pins upload, collapses tool sections and normalizes sidebar control sizing'
reset_profile
...
reset_profile
run_product_case "pdf-page-list-quick-add-smoke.html" "$OUT_DIR/pdf-page-list-quick-add-smoke-dom.html" 'data-pdf-page-list-quick-add-smoke="pass"' 'PASS: multi-file PDF upload uses reorder modal and removes page-list quick-add controls'

bash "$ROOT_DIR/scripts/run_pdf_print_workflow_focus_smoke.sh"
echo "PDF program unified shell, pinned upload, collapsible sidebar, divider-modal, fast-insert, upload-order modal and product-focus browser smokes passed using $BROWSER"

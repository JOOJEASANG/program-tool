...
if ! grep -q 'PASS: leaflet2 left-right and top-bottom folds, guides, safety and project persistence' "$DOM_OUT"; then echo "Leaflet2 layout completion marker missing." >&2; cat "$DOM_OUT" >&2; exit 1; fi
for marker in 'data-leaflet2-left-right="true"' 'data-leaflet2-top-bottom="true"' 'data-leaflet2-horizontal-guide="true"' 'data-leaflet2-safety="true"' 'data-leaflet2-portable="true"' 'data-leaflet2-final-gate="true"' 'data-leaflet2-layout-stage="leaflet2-left-right-and-top-bottom-layout"'; do

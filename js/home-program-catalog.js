(function(){
  ...
  window.HomeProgramCatalog={install,loadCatalog,applyCatalog,decorateProgramIcons,stage:'admin-managed-home-navigation-and-programs-with-svg-icons'};install();
})();
// Shared professional shell visuals and common actions for embedded design workspaces.
(function(){
  'use strict';
  if(window.DesignEditorProfessionalShellUi)return;
  ...
  function installStyles(){
    if(byId('designProfessionalUiStyles'))return;
  ...
  function sync(){
    installStyles();tagSidebarSections();ensureToolbarCtas();syncProductLabel();
    document.documentElement.dataset.professionalUi='2';
    document.documentElement.dataset.designWorkspace='three-pane';
    document.documentElement.dataset.professionalShellOwnership='shared';
    return true;
  }
  ...
  window.DesignEditorProfessionalShellUi={sync,installStyles,tagSidebarSections,ensureToolbarCtas,syncProductLabel,makePdf,openProduct,openCheck,openCompose,stage:'design-editor-professional-shell-ui-v1'};

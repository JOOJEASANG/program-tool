...
(function(){
  ...
  function bindObserver(){
    ...
    observer=new MutationObserver(syncRows);if(members)observer.observe(members,{childList:true,subtree:true});if(recent)observer.observe(recent,{childList:true,subtree:true});
  }

(function(){
  ...
  function helpers(){
    ...
    if(location.pathname==='/'||location.pathname.endsWith('/index.html')){
      load('homeCleanupScript','/js/home-cleanup.js?v='+VERSION);
      load('homeHeroUpgradeScript','/js/home-hero-upgrade.js?v='+VERSION);
      load('homeHeaderFooterRefineScript','/js/home-header-footer-refine.js?v='+VERSION);
    }
    ...
    if(isPath('/tools/pdf-Checker.html','/tools/preflight.html','/pdf-preflight','/pdf-preflight/index.html')){
      load('pdfCheckerFinalGuardScript','/js/pdf-checker-final-guard.js?v='+VERSION);
      load('pdfPreflightPanelBalanceScript','/js/pdf-preflight-panel-balance.js?v='+VERSION);
    }

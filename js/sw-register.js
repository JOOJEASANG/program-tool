(function(){
  ...
  function isPdfEditorPath(){
    return isPath('/tools/pdf-editor.html','/pdf-editor','/pdf-editor/index.html','/pdf-editor-advanced')
      ||currentPath.startsWith('/pdf-editor-advanced/');
  }
  function isProtectedRuntimePage(){
    return isPdfEditorPath()||isPath(
  ...
  async function helpers(){
    ...
    if(isPdfEditorPath())tasks.push(loadPdfEditorRuntime());

...
(function(){
  ...
  function renderList(){
    ...
    programs.forEach(program=>{
      ...
      const stateClass=!program.visible?'hidden':program.status==='active'?'':'coming';

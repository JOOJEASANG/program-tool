...
(function(){
  ...
  function ensureLargeStorage(){
    ...
    return new Promise((resolve,reject)=>{
      ...
      script.id='pdfUtilityDirectLargeStorageScript';
      script.src='/js/pdf-suite/direct-tool-large-storage.js?v=20260915-1';
  ...
  function boot(){ensureLargeStorage().catch(()=>{}).finally(install);}

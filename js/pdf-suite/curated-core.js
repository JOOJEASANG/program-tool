  ...
  const GROUPS=[
    {
      id:'inspect',
      label:'PDF 검사 · 최적화',
      desc:'파일 검사 · 압축 · 인쇄 문제 자동 수정',
      tools:['PDF 프리플라이트','PDF 압축','안전 자동 수정']
    },
    {
      id:'pages',
      label:'페이지 · 문서',
      desc:'합치기 · 빈 페이지 · 회전 · 배경/여백',
      tools:['PDF 합치기','빈 페이지 자동 제거','전체 페이지 회전','페이지 순서 역순','여백·크롭·배경']
    },
    {
      id:'convert',
      label:'변환 · OCR',
    ...
    },
    {
      id:'security',
      label:'편집 · 보안',
      desc:'페이지 정리 · 추출 · 암호 · 개인정보',
      tools:['페이지 추출·나누기','시각적 페이지 정리','AES-256 암호 설정','암호 해제']
    }
  ];

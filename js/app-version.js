...
(function(){
  ...
  function loadScopedEnhancements(){
    ...
    if(
      ...
      loadScopedScript('aiDesignFeatureGateScriptV1','/js/ai-design-feature-gate.js?v=20260824-1');
      loadScopedScript('designPreviewGuideEnhancementScriptV1','/js/design-editor/preview-guide-enhancement.js?v=20260825-2');
      loadScopedScript('designCoverPreviewCleanupScriptV1','/js/design-editor/cover-preview-cleanup.js?v=20260825-2');
    }
    if(

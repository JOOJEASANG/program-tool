...
(function(){
  ...
  function restartPrecisionInputHistory(target){
    ...
    try{
      ...
      console.warn('[pdf-advanced-runtime] precision input history bridge failed',error);
    }
  }
  ...
  function syncPrecisionInputValue(target){
    ...
    try{
      ...
      console.warn('[pdf-advanced-runtime] precision input value sync failed',error);
    }
  }

...
(()=>{if(document.getElementById('programStudioCacheBootstrap'))return;const s=document.createElement('script');s.id='programStudioCacheBootstrap';s.src='/js/sw-register.js?v=2026.07.23.005';s.defer=true;document.head.appendChild(s)})();
...
window.addEventListener('DOMContentLoaded',async()=>{
  ...
  if(footer&&!footer.dataset.programToolFooter){footer.dataset.programToolFooter='1'}
});
